...
const UIOverlay: React.FC<{ isPlaying: boolean; trackingStatus: string; gesture: GestureType; themeName: string; onStart: () => void; }> = ({ isPlaying, trackingStatus, gesture, themeName, onStart }) => {
  return html`
